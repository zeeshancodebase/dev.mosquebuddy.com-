...
const SHEET_DEFAULT_HEIGHT = 580;
const SHEET_EXPANDED_HEIGHT = 640;
...
export default function EditFieldsSheet({
  ...
  const sheetAnimatedStyle = useAnimatedStyle(() => {
    const height = interpolate(
      kbProgress.value,
      [0, 1],
      [SHEET_DEFAULT_HEIGHT, SHEET_EXPANDED_HEIGHT],
      Extrapolation.CLAMP
    );
    return { height };
  });
...
// before keyboard correction | should be deleted if kayboard works fine
// src/components/EditFieldsSheet.js
// import React, { useState, useEffect } from "react";
// import {
